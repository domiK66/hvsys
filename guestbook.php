                        ...
                        <tbody>
                            <?php 
                                while($res = mysqli_fetch_array($result)) { 		
                                    ...
                                    echo "<td><a href=\"edit.php?id=$res[id]\" class=\"btn btn-xs btn-primary\">Edit</a><a href=\"delete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\" class=\"btn btn-xs btn-danger\" disabled>Delete</a></td>";		
                                }
                            ?>
                        </tbody>
                    </table>
